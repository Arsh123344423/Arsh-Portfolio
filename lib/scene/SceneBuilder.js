...
/**
 * SceneBuilder — Creates the Three.js scene, camera, renderer, lights, and particles.
 * Pure utility function, no React dependency.
 *
 * @param {HTMLCanvasElement} canvas
 * @returns {{ scene, camera, renderer, particles }}
 */
export function buildScene(canvas) {
  ...
  return { scene, camera, renderer, particles, cleanup: () => window.removeEventListener('resize', onResize) };
}
