...
/**
 * ModelLoader — Loads the cyber-samurai GLTF and detects the head mesh.
 * Pure utility function, no React dependency.
 *
 * @param {THREE.Scene} scene
 * @param {(progress: number) => void} [onProgress] — 0–100
 * @returns {Promise<{ model, headTarget, modelBasePosition, modelBaseRotation, headBasePosition, headBaseRotation }>}
 */
  ...
  return new Promise((resolve, reject) => {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        // Keep samurai framed on the right side of the hero viewport.
        ...
        // Head detection (bounding-box scoring)
        ...
        resolve({
          ...
          modelBaseRotation: model.rotation.clone(),
          headBasePosition:  headTarget.position.clone(),
          headBaseRotation:  headTarget.rotation.clone(),
        });
      },
